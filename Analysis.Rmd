...
rm(df_questionnaire, df_physiological, df_sample, df_event, df_pupil)
...
gamedf <- gamedf %>% dplyr::select(-pupil_timestamp, -headdist_min, -contains("lefthand"), -contains("FakeMole"), -contains("minute"), -contains("second"), -file_path_mean, -minute_mean, -second_mean, -contains("Fake_Mole"), -file_path_sum, -contains("nni"), -total_power, -vlf)
