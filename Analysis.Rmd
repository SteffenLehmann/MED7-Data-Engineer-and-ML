...
subset %>%
  ggplot( aes(x=Timestamp, y=eyedist, group=factor(file_path), color=factor(file_path))) +
    ...
    ggtitle("Total left eye movement over time") +
    theme_ipsum() +
    ylab("Eye movement") 
    #geom_smooth(aes(group = factor(file_path)), method = "lm", se = FALSE)
...
physio_test$second <- floor(physio_test$second)

# https://statisticsglobe.com/r-dplyr-join-inner-left-right-full-semi-anti
AggDF <- left_join(event_data, physio_test, by = c("file_path","minute", "second"))
