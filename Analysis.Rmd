...
indexed_test1 = test1.set_index(["Timestamp"])           # Create a datetime index
indexed_test1.rolling(100)                             # Create rolling windows
indexed_test1.rolling(100).mean()                      # Then apply functions to rolling windows
